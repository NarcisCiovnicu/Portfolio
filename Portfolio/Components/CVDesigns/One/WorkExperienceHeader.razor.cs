...
namespace Portfolio.Components.CVDesigns.One
{
    public partial class WorkExperienceHeader
    {
        ...
        private string StartDateText => WorkExperience.StartDate.ToString(Constants.MonthAndYearDateFormat, _dateCultureInfo);
        private string EndDateText => WorkExperience.EndDate?.ToString(Constants.MonthAndYearDateFormat, _dateCultureInfo) ?? "Present";
